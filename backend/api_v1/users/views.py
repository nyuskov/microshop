...
from . import crud
from .schemas import CreateUser, PublicUserSchema, UserWithDetailsSchema, UserCreatedResponseSchema # Импортируем новую схему
...
@router.post(
    ...
    response_model=UserCreatedResponseSchema, # <-- Указываем новую схему для ответа
)
